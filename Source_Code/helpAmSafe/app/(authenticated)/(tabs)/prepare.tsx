          ...
          {emergencies.map((emergency) => (
            <TouchableOpacity
              ...
              style={[
                ...
                selectedEmergency === emergency.name &&
                  styles.selectedGridItemWrapper,
              ]}
          ...
          >
            ...
            <View style={styles.textContainer}>
              ...
              <Text style={styles.subtitle}>
                Essential tools needed for emergency escape
              </Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.itemContainer}
            onPress={() => console.log("First Aid pressed")}
          >
            <View style={styles.iconCircle}>
            ...
            <View style={styles.textContainer}>
              ...
              <Text style={styles.subtitle}>
                Learn how to administer first aid in trouble
              </Text>
            </View>
          </TouchableOpacity>
        </View>
